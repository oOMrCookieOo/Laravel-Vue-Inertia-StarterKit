...
import {BellDotIcon, BellIcon, MoonIcon, SunIcon,LanguagesIcon} from "lucide-vue-next";
import {
...
<template>
    <div class="hidden md:flex" v-if="$page.props.breadcrumbs?.length">
        <Breadcrumb>
            <BreadcrumbList>
                <BreadcrumbItem>
            ...
            <DropdownMenuContent align="end" class="w-32">
                ...
                <DropdownMenuItem
                    ...
                    <svg class="size-4" viewBox="0 5 36 26" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0 9.059V13h5.628zM4.664 31H13v-5.837zM23 25.164V31h8.335zM0 23v3.941L5.63 23zM31.337 5H23v5.837zM36 26.942V23h-5.631zM36 13V9.059L30.371 13zM13 5H4.664L13 10.837z"
                              fill="#00247D"/>
                        <path d="M25.14 23l9.712 6.801c.471-.479.808-1.082.99-1.749L28.627 23H25.14zM13 23h-2.141l-9.711 6.8c.521.53 1.189.909 1.938 1.085L13 23.943V23zm10-10h2.141l9.711-6.8c-.521-.53-1.188-.909-1.937-1.085L23 12.057V13zm-12.141 0L1.148 6.2C.677 6.68.34 7.282.157 7.949L7.372 13h3.487z"
                              fill="#CF1B2B"/>
